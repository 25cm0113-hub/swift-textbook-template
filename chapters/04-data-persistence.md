...
## この章で学ぶこと
この章ではAppstoreとSwiftdataというものをつかって端末にデータを永続的に保存する方法を学ぶ
...
**このアプリは何をするものか：**
シンプルなメモアプリ。＋ボタンで新規メモを追加することができる。
また、追加したメモをタップすることでメモを編集することができる。編集画面ではタイトル、内容を編集することもできる。
...
**もしこう書かなかったら：**
**じつはinit()を書かなくてもOK:**
Swiftは書かなくても自動でイニシャライザを書いてくれる
しかし値を入れるときに全て自分でコーディングしなければならない。
イニシャライザを使えばルールを自由に設定できたり初期値を設定することができる
